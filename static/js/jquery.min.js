    ...
    $.fn.crzShare = function(options){
        var defaults = {
                ...
                tqzone:{//分享到QQ空间
                    ...
                    // pic : 'img-src' //默认图片
                    summary : '车融资',
                    desc : '“双十二”又来了，那边花钱这边挣！在车融资理财，资金多重保障，年化收益11%~14%，带你体验轻松赚钱乐趣！'
                },
                douban:{//分享到豆瓣
                    url : encodeURIComponent(window.location.href),
                    title : document.title,
            ...
            shareUrl = {
                ...
                tqzone : 'http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?desc={desc}&url={url}&pics={pic}&title={title}&summary={summary}',
                douban : 'http://www.douban.com/recommend/?url={url}&title={title}&name={name}',
                qq : 'http://connect.qq.com/widget/shareqq/index.html?url={url}&pic={pic}&title={title}&summary={summary}'
            };
